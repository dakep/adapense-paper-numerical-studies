...
plot_any_pct <- function (plot_d, what, ylab, guide, ylim = c(0, 1), pct = TRUE, base_size = 11,
...
```{r scenario_1-prediction_accuracy-selected, fig.width=7, fig.height=3, out.width='100%'}
scenario_1 %>% 
...
```{r scenario_1-mcc, out.width='100%', fig.width=7, fig.height=3}
scenario_1 %>% 
  filter(cv_type == 'se' | method == 'I-LAMM',
         !str_starts(resid_dist, fixed('Stable'))) %>% 
...
```{r good_leverage-sens_spec, out.width='100%', fig.width=7, fig.height=3}
good_leverage %>% 
